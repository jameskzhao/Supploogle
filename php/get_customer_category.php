...
while($row_get_category = mysql_fetch_assoc($get_category)){
    //$subcategory_array = get_subcategories($row_get_category['business_category']);
    //$temp_array = array($row_get_category['business_category']=>$subcategory_array);
    array_push($category_array, $row_get_category['business_category']);
}
