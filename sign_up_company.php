                ...
                <div id="customer_form">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <table class="table table-striped">
                            <tr>
                                <td>Name:</td>
                                <td><input type="text" name="company_name" class="form-control form_input" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Street:</td>
                                <td><input type="text" name="company_street" class="form-control form_input" required="required"/></td>
                            </tr>
                            <tr>
                                <td>City</td>
                                <td><input type="text" name="company_city" class="form-control form_input" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Province/State</td>
                                <td><input type="text" name="company_province" class="form-control form_input" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Country</td>
                                <td><input type="text" name="company_country" class="form-control form_input" required="required"/></td>
                            </tr>
                            <tr>
                                <td>Postal Code</td>
                                <td><input type="text" name="company_postalcode" class="form-control form_input" required="required"/></td>
                            </tr>
